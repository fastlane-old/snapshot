    ...
    def self.available_options
      ...
      @options ||= [
        ...
        FastlaneCore::ConfigItem.new(key: :build,
                                     short_option: "-b",
                                     env_name: "SNAPSHOT_BUILD",
                                     description: "Should the project explicitly be built first? (this can solve problems of timing out while waiting for simulator on some systems but cause it on others)",
                                     is_string: false,
                                     default_value: false),
